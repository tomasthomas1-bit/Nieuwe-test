...
const translations = {
  nl: {
    ...
    verificationEmailSent: 'We hebben een verificatielink gestuurd naar',
    clickLinkToVerify: 'Klik op de link in de e-mail om je account te activeren.',
    ...
    emailResent: 'Verificatie-e-mail opnieuw verzonden!',
    completeYourProfile: 'Maak je profiel compleet',
    letsGetStarted: 'Laten we beginnen! Voeg een foto toe en selecteer je favoriete sporten.',
    addPhoto: 'Foto toevoegen',
    selectSports: 'Selecteer je sporten',
    continueBtn: 'Doorgaan',
    skipForNow: 'Later doen',
    running: 'Hardlopen', cycling: 'Fietsen', swimming: 'Zwemmen', triathlon: 'Triatlon',
    hiking: 'Wandelen', gym: 'Fitness', yoga: 'Yoga', tennis: 'Tennis', football: 'Voetbal',
    basketball: 'Basketbal', golf: 'Golf', skiing: 'Skiën', climbing: 'Klimmen', rowing: 'Roeien',
    profileSetupComplete: 'Profiel compleet!', welcomeToAthlo: 'Welkom bij Athlo',
    emailNotVerified: 'Je account is nog niet geverifieerd. Controleer je e-mail.',
  },
  en: {
    ...
    letsGetStarted: 'Let\'s get started! Add a photo and select your favorite sports.',
    addPhoto: 'Add photo',
    selectSports: 'Select your sports',
    continueBtn: 'Continue',
    skipForNow: 'Skip for now',
    running: 'Running', cycling: 'Cycling', swimming: 'Swimming', triathlon: 'Triathlon',
    hiking: 'Hiking', gym: 'Gym', yoga: 'Yoga', tennis: 'Tennis', football: 'Football',
    basketball: 'Basketball', golf: 'Golf', skiing: 'Skiing', climbing: 'Climbing', rowing: 'Rowing',
    profileSetupComplete: 'Profile complete!', welcomeToAthlo: 'Welcome to Athlo',
    emailNotVerified: 'Your account is not verified yet. Check your email.',
  },
  fr: {
    ...
    verificationEmailSent: 'Nous avons envoyé un lien de vérification à',
    clickLinkToVerify: 'Cliquez sur le lien dans l\'email pour activer votre compte.',
    didntReceiveEmail: 'Vous n\'avez pas reçu d\'email?',
    resendVerification: 'Renvoyer',
    alreadyVerified: 'Déjà vérifié?',
    goToLogin: 'Aller à la connexion',
    emailResent: 'Email de vérification renvoyé!',
    completeYourProfile: 'Complétez votre profil',
    letsGetStarted: 'Commençons! Ajoutez une photo et sélectionnez vos sports préférés.',
    addPhoto: 'Ajouter une photo',
    selectSports: 'Sélectionnez vos sports',
    continueBtn: 'Continuer',
    skipForNow: 'Passer pour l\'instant',
    running: 'Course', cycling: 'Cyclisme', swimming: 'Natation', triathlon: 'Triathlon',
    hiking: 'Randonnée', gym: 'Gym', yoga: 'Yoga', tennis: 'Tennis', football: 'Football',
    basketball: 'Basketball', golf: 'Golf', skiing: 'Ski', climbing: 'Escalade', rowing: 'Aviron',
    profileSetupComplete: 'Profil complété!', welcomeToAthlo: 'Bienvenue sur Athlo',
    emailNotVerified: 'Votre compte n\'est pas encore vérifié. Vérifiez votre email.',
  },
  de: {
    ...
    verificationEmailSent: 'Wir haben einen Verifizierungslink gesendet an',
    clickLinkToVerify: 'Klicken Sie auf den Link in der E-Mail, um Ihr Konto zu aktivieren.',
    didntReceiveEmail: 'Keine E-Mail erhalten?',
    resendVerification: 'Erneut senden',
    alreadyVerified: 'Bereits verifiziert?',
    goToLogin: 'Zur Anmeldung',
    emailResent: 'Verifizierungs-E-Mail erneut gesendet!',
    completeYourProfile: 'Vervollständigen Sie Ihr Profil',
    letsGetStarted: 'Legen wir los! Fügen Sie ein Foto hinzu und wählen Sie Ihre Lieblingssportarten.',
    addPhoto: 'Foto hinzufügen',
    selectSports: 'Wählen Sie Ihre Sportarten',
    continueBtn: 'Weiter',
    skipForNow: 'Jetzt überspringen',
    running: 'Laufen', cycling: 'Radfahren', swimming: 'Schwimmen', triathlon: 'Triathlon',
    hiking: 'Wandern', gym: 'Fitness', yoga: 'Yoga', tennis: 'Tennis', football: 'Fußball',
    basketball: 'Basketball', golf: 'Golf', skiing: 'Skifahren', climbing: 'Klettern', rowing: 'Rudern',
    profileSetupComplete: 'Profil vollständig!', welcomeToAthlo: 'Willkommen bei Athlo',
    emailNotVerified: 'Ihr Konto ist noch nicht verifiziert. Überprüfen Sie Ihre E-Mail.',
  },
  es: {
    ...
    verificationEmailSent: 'Enviamos un enlace de verificación a',
    clickLinkToVerify: 'Haz clic en el enlace del correo para activar tu cuenta.',
    ...
    letsGetStarted: '¡Empecemos! Añade una foto y selecciona tus deportes favoritos.',
    addPhoto: 'Añadir foto',
    selectSports: 'Selecciona tus deportes',
    continueBtn: 'Continuar',
    skipForNow: 'Omitir por ahora',
    running: 'Correr', cycling: 'Ciclismo', swimming: 'Natación', triathlon: 'Triatlón',
    hiking: 'Senderismo', gym: 'Gimnasio', yoga: 'Yoga', tennis: 'Tenis', football: 'Fútbol',
    basketball: 'Baloncesto', golf: 'Golf', skiing: 'Esquí', climbing: 'Escalada', rowing: 'Remo',
    profileSetupComplete: '¡Perfil completo!', welcomeToAthlo: 'Bienvenido a Athlo',
    emailNotVerified: 'Tu cuenta aún no está verificada. Revisa tu correo.',
  },
  it: {
    ...
    verificationEmailSent: 'Abbiamo inviato un link di verifica a',
    clickLinkToVerify: 'Clicca sul link nell\'email per attivare il tuo account.',
    didntReceiveEmail: 'Non hai ricevuto l\'email?',
    resendVerification: 'Invia di nuovo',
    alreadyVerified: 'Già verificato?',
    goToLogin: 'Vai al login',
    emailResent: 'Email di verifica reinviata!',
    completeYourProfile: 'Completa il tuo profilo',
    letsGetStarted: 'Iniziamo! Aggiungi una foto e seleziona i tuoi sport preferiti.',
    addPhoto: 'Aggiungi foto',
    selectSports: 'Seleziona i tuoi sport',
    continueBtn: 'Continua',
    skipForNow: 'Salta per ora',
    running: 'Corsa', cycling: 'Ciclismo', swimming: 'Nuoto', triathlon: 'Triathlon',
    hiking: 'Escursionismo', gym: 'Palestra', yoga: 'Yoga', tennis: 'Tennis', football: 'Calcio',
    basketball: 'Basket', golf: 'Golf', skiing: 'Sci', climbing: 'Arrampicata', rowing: 'Canottaggio',
    profileSetupComplete: 'Profilo completato!', welcomeToAthlo: 'Benvenuto su Athlo',
    emailNotVerified: 'Il tuo account non è ancora verificato. Controlla la tua email.',
  },
  pt: {
    ...
    verificationEmailSent: 'Enviamos um link de verificação para',
    clickLinkToVerify: 'Clique no link do email para ativar sua conta.',
    didntReceiveEmail: 'Não recebeu o email?',
    resendVerification: 'Reenviar',
    alreadyVerified: 'Já verificado?',
    goToLogin: 'Ir para o login',
    emailResent: 'Email de verificação reenviado!',
    completeYourProfile: 'Complete seu perfil',
    letsGetStarted: 'Vamos começar! Adicione uma foto e selecione seus esportes favoritos.',
    addPhoto: 'Adicionar foto',
    selectSports: 'Selecione seus esportes',
    continueBtn: 'Continuar',
    skipForNow: 'Pular por agora',
    running: 'Corrida', cycling: 'Ciclismo', swimming: 'Natação', triathlon: 'Triathlon',
    hiking: 'Trilha', gym: 'Academia', yoga: 'Yoga', tennis: 'Tênis', football: 'Futebol',
    basketball: 'Basquete', golf: 'Golfe', skiing: 'Esqui', climbing: 'Escalada', rowing: 'Remo',
    profileSetupComplete: 'Perfil completo!', welcomeToAthlo: 'Bem-vindo ao Athlo',
    emailNotVerified: 'Sua conta ainda não foi verificada. Verifique seu email.',
  },
};
                    ...
                    {(() => {
                      ...
                      return (
                        <View style={{ width: galleryWidth, height: '100%', borderRadius: 16, overflow: 'hidden', position: 'relative' }}>
                          ...
                          {/* SPORT SELECTOR - BINNEN de stats card */}
                          <ScrollView 
                            horizontal 
                            showsHorizontalScrollIndicator={false}
                            style={{ position: 'absolute', top: 12, left: 0, right: 0, zIndex: 10 }}
                            ...
                            {sportTypes.map(sport => (
                              <TouchableOpacity
                                ...
                                style={{
                                  ...
                                  paddingVertical: 6,
                                  borderRadius: 16,
                                  backgroundColor: selectedSport === sport.id ? 'rgba(255,255,255,0.95)' : 'rgba(255,255,255,0.3)',
                                  flexDirection: 'row',
                                  alignItems: 'center',
                                  gap: 5,
                                }}
                              >
                                <Ionicons 
                                  name={sport.icon} 
                                  size={14} 
                                  color={selectedSport === sport.id ? '#FF6B35' : '#fff'} 
                                />
                                <Text style={{
                                  fontFamily: 'Montserrat_600SemiBold',
                                  fontSize: 12,
...
/* ================= TABS ================= */
function MainTabs({ api, theme, navigation }) {
  const { t } = useContext(LanguageContext);
  const tabHeader = {
    headerBackground: () => (
      <LinearGradient
  ...
  return (
    ...
    >
      <Tabs.Screen name="Ontdekken" options={{ title: t('discover'), headerShown: false }}>
        {(props) => <DiscoverScreen {...props} api={api} theme={theme} user={{ profile_photo_url: profilePhotoUrl }} rootNavigation={navigation} />}
      </Tabs.Screen>
